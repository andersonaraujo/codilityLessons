...
/**
 * Result at codility: https://codility.com/demo/results/demoNG9SN9-Y9S/
 * <p>
 ...
 *
 * @author andersonaraujo on 08/09/2015.
 */
    ...
    public int[] solution(int N, int[] A) {
        ...
        for (int opValue : A) {
            if (opValue > N) {
                ...
                //Lazy update of max
                if (maxCounter > counters[opValue - 1]) {
                    counters[opValue - 1] = maxCounter;
                }
                counters[opValue - 1] += 1;
                currentMax = Math.max(currentMax, counters[opValue - 1]);
            }
        }
